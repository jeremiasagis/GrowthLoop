  ...
  return (
    <div>
      <div
        ...
        style={{ position: "relative", width: "100%", aspectRatio: "4/3", background: "var(--bg-2)", border: "1px solid var(--line)", borderRadius: "var(--r-md)", overflow: "hidden", cursor: editable ? "crosshair" : "default" }}>
        {/* zonas */}
        ...
        {my && <span style={{ position: "absolute", ...pos(my.x, my.y), width: 20, height: 20, borderRadius: 99, background: "var(--green)", border: "2px solid #fff", transform: "translate(-50%,-50%)", boxShadow: "0 0 10px rgba(0,232,122,0.6)", zIndex: 2 }} title="tu posición" />}
        {centroid && (
