...
export interface InitiativeData {
  ...
  follow?: { current?: number; target?: number; unit?: string; signalName?: string; signalNow?: string; onTrack?: boolean; blockers?: string[]; actionStatus?: { text: string; who: string; status: string; due?: string }[]; betCheckins?: { name: string; signal: string; value: string; pct: number; actions: { text: string; who: string; status: string }[] }[]; newActions?: { text: string; who: string }[]; escalateTo?: string; decision?: string; fidelity?: string; fidelityNote?: string; adjustNote?: string; startedAt?: string; honesty?: { green: number; yellow: number; red: number }; signalLog?: { date: string; value: string }[]; finalHonesty?: string; signalToken?: string; signalSource?: "pulse" | "commitments" };
