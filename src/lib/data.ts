...
export interface InitiativeData {
  ...
  proof?: { betIf?: string; betThen?: string; signal?: string; responsible?: string; deadline?: string; risks?: string[]; committed?: number; secondaryIdeas?: { name: string; ice: number }[] };
